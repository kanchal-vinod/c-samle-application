    ...
    public partial class Form3 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (!(txttagname.Text == string.Empty))
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("inserted successfully","saved",MessageBoxButtons.OK,MessageBoxIcon.Information);
            }
            else 
            {
                MessageBox.Show("tagname is required","warning",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
